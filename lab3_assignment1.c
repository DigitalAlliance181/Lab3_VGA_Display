...
int main(void)
{
  ...
  displays */
  char text_top_row[50] = "Digital Alliance\0"
  char text_bottom_row[50] = "Kaila Balacio, Chris Bird, Lillie Deas\0"
  ...
  VGA_box (0*4-2, 0*4, 639*4+1, 479*4,0xF800); //Fills whole screen with a red box? Will it override?
  VGA_box (1*4-2, 28*4, 79*4+1, 32*4, 0xGREEN); //Creates a green box in the center of the screen. It is not square.
  
  // WE GOTTA FIGURE OUT HOW TO MAKE THE  BOX GREEN  ^^^^^^
